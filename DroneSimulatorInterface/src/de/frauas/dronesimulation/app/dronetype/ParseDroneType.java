...
public class ParseDroneType {
    public static void parseJsonResponse(String input, DroneList drone) {
        ...
        System.out.println(
                "\n" + "Drone " + typeId + ": Manufacturer " + manufacturer + " Type name: " + typeName + " "
                        + "Weight: " + weight + " Max speed: " + maxSpeed + "Km/h)" + " Battery capacity: "
                        + batteryCapacity + " Control range: " + controlRange + "Max carriage:" + maxCarriage
                        + "g" + "\n");
